...
if(isset($_SESSION['loggedintutor']) && isset($_SESSION['centerID'])){
   ...
   <nav class="navbar navbar-inverse">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav navbar-right">
            <li> <a href="#/manageTutor">Personal Details</a></li>
            <li> <a  href="#/tutorLessons">My Lessons</a></li>
            <li class="dropdown">
    ...
    <div class="indexpage row container-fluid">
        <div class="uiview col-xs-12 col-sm-11">
    ...
    <!--Controllers-->
    <script src="controllers/tutorController.js"></script>
    <script src="controllers/timetableController.js"></script>
    <!--Services-->
    <script src="services/tutorService.js"></script>
